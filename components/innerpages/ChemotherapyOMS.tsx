export default function OncologistsAppointment() {
  return (
    <div className="container mt-8 md:mt-16">
      <h1>Химиотерапия по ОМС</h1>
      <p className="custom-text">
        Под словом «химиотерапия» обычно понимают лекарственную
        противоопухолевую терапию, которая в себя включает непосредственно
        химиотерапию, таргетную терапию, гормонотерапию, иммунотерапию и
        сочетание их видов.
      </p>
      ...
      <p className="custom-text">
        Степмед Клиник участвует в реализации Программы ОМС в части
      ...
      <div className="custom-list">
        <p className="custom-list-heading">
          Для проведения лекарственной противоопухолевой терапии в Степмед
          Клиник в рамках ОМС необходимо:
        </p>
        ...
        <div className="custom-list-container">
          ...
          <p className="custom-list-item">
            ...
            первичной помощи (поликлиники по месту жительства, а также
            направление может выдать онколог первичного онкологического
            кабинета, центра амбулаторной онкологической помощи либо
      ...
      <p className="custom-text">
        ...
        региона страхования, не могут быть приняты для оказания
        противоопухолевого лечения.
      </p>

      <p className="custom-text">
        Узнать информацию о своем полисе вы можете на сайте территориального
        фонда Вашего региона{' '}
        <a
        ...
        или позвонив в свою страховую компанию, название и номер телефона
        которой указаны в полисе.
      </p>
    </div>
  );
}
